        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('banners.create') }}"> <i class="fa fa-plus"></i> Add
                        New Banner</a>
                                    ...
                                    <td>
                                        <div class="action-button-list">
                                            ...
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal"
                                                data-id="{{ $banner->id }}"
                                                data-route="{{ route('banners.destroy', $banner->id) }}"> <i
    ...
    <script>
        $(document).ready(function() {
            ...
            function filterData(filters) {
                ...
                $.ajax({
                    url: "<?php echo url('admin/banners'); ?>",
                    data: filters,
