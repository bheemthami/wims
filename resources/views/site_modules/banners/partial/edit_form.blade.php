<fieldset class="fieldset-border">
	...
	<div class="col-md-12 form-group">
		@if($banner->image)
		<img src="{{ asset('uploads/banners/'.$banner->image)}}" width="100px">
		@else
...
<fieldset class="fieldset-border">
	...
	<div class="row col-md-12">
		<div class="col-md-4 form-group">
			...
			{!! Form::number('order',$banner->order,['class'=>'form-control']) !!}
			@if($errors)      
	...
	<div class="row col-md-12">
		<div class="col-md-4 form-group">
			...
			{!! Form::select('status',$data['publish_options'],$banner->status,['class'=>'form-control']) !!}
			@if($errors)      
