        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('programs.create') }}"> <i class="fa fa-plus"></i> Add
                        New Program</a>
                </div>
            </div>
            <div class="box-body">
                                    ...
                                    <td>
                                        <div class="action-button-list">
                                            <a class="btn btn-sm btn-primary"
                                                href="{{ route('programs.show', [$program->id]) }}"><i
                                                    class="fa fa-eye"></i></a>
                                            ...
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal"
                                                data-id="{{ $program->id }}"
                                                data-route="{{ route('programs.destroy', $program->id) }}"> <i
    ...
    <script>
        $(document).ready(function() {
            ...
            function filterData(filters) {
                ...
                $.ajax({
                    url: "<?php echo url('admin/programs'); ?>",
                    data: filters,
