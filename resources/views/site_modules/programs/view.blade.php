        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('programs.edit', [$program->id]) }}"><i
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @if ($program->image)
                                        <a href="{{ asset('uploads/programs/' . $program->image) }}" target="_blank">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($program->attachment)
                                        <a href ="{{ asset('uploads/programs/' . $program->attachment) }}"
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <p><strong> Display Order: </strong><label
                                    class="label label-success">{{ $program->order }}</label></p>
                        </div>
                        <div class="col-md-6">
