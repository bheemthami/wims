<fieldset class="fieldset-border">
	...
	<div class="col-md-12 form-group">
		...
		<input id="summary" type="textarea" class="form-control" placeholder="summary goes here..." name="summary" value="{{ $program->summary }}">
		@if($errors)      
	...
	<div class="col-md-12 form-group">
		...
		<textarea id="editor" name="description" class="form-control" placeholder="description goes here...">{!! $program->description !!} </textarea>
	...
	<div class="col-md-12 form-group">
		...
		@if($program->image)
		<img src="{{ asset('uploads/programs/'.$program->image)}}" width="100px">
		@else
	...
	<div class="col-md-12 form-group">
		...
		<a href ="{{ asset('uploads/programs/'.$program->attachment)}}"> <i class="fa fa-file"> view </i> </a>
		@else
...
<fieldset class="fieldset-border">
	...
	<div class="col-md-6 form-group">
		...
		{!! Form::select('status',$data['publish_options'],$program->status,['class'=>'form-control']) !!}
		@if($errors)      
