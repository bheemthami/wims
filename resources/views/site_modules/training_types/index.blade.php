        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('training-types.create') }}"> <i
                            class="fa fa-plus"></i>
                                    ...
                                    <td>
                                        <div class="action-button-list">
                                            <a class="btn btn-sm btn-success"
                                                href="{{ route('training-types.edit', [$training_type->id]) }}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal"
                                                data-id="{{ $training_type->id }}"
                                                data-route="{{ route('training-types.destroy', $training_type->id) }}"> <i
    ...
    <script>
        $(document).ready(function() {
            ...
            function filterData(filters) {
                ...
                $.ajax({
                    url: "<?php echo url('admin/training-types'); ?>",
                    data: filters,
