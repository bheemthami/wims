        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('facilities.edit', [$facility->id]) }}"><i
                        ...
                        <div class="col-md-4">
                                        ...
                                        <div class="img-wrapper">
                                            <a href="{{ asset('uploads/media/' . $img->image) }}" target="_blank">
                                                <img class="img img-responsive"
                                                    src="{{ asset('uploads/media/' . $img->image) }}" width="100px"
                                                    height="100px" />
                                            </a>
                                        </div>
                                    @empty
                            ...
                            <div>
                                ...
                                @if ($facility->attachment)
                                    <a href="{{ asset('uploads/facilities/' . $facility->attachment) }}" target="_blank"><i
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <p><strong> Display Order: </strong><label
                                        class="label label-success">{{ $facility->order }}</label></p>
                            </div>
                            <div class="col-md-6">
