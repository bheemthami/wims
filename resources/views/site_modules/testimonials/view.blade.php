	...
	<div class="box">
		<div class="box-header with-border">
			<div class="box-tools pull-right">
				...
				<a class="btn btn-sm btn-danger" href="{{ route('testimonials.index')}}"><i class="fa fa-times"></i></a>
		...
		<div class="box-body">
			<fieldset class="fieldset-border">
				...
				<div class="mb-3 col-md-12">
					...
					<div class="col-sm-10">
						...
						<img src="{{ asset('uploads/testimonials/'.$testimonial->image)}}" width="200px">
						@else
			...
			<fieldset class="fieldset-border">
				...
				<div class="mb-3 col-md-12">
					<div class="col-md-6">
						<p><strong> Order: </strong><label class="label label-info">{{$testimonial->order}}</label></p>
					</div>
					<div class="col-md-6">
						<p><strong>Publish status: </strong> <label for="" class="label label-{{$testimonial->status?'success':'warning'}}"> {{ ($testimonial->status == 1) ? 'Publish' : 'Draft' }} </label></p>	
					</div>
				</div>
