		...
		<div class="box-body">
			<fieldset class="fieldset-border">
				...
				<div class="col-md-12">
					...
					@if($page->image)
					<img src="{{ asset('uploads/pages/'.$page->image)}}" width="200px">
					@else
				...
				<div class="col-md-12">
					...
					@if($page->attachment)
					<a href ="{{ asset('uploads/pages/'.$page->attachment)}}" target="_blank"><i class="fa fa-eye"></i> view</a>
					@else
			...
			<fieldset class="fieldset-border">
				...
				<div class="col-md-12">
					<div class="col-md-6">
						<p><strong> Display Order: </strong><label class="label label-success">{{$page->order}}</label></p>
					</div>
					<div class="col-md-6">
