<fieldset class="fieldset-border">
	...
	<div class="col-md-12 form-group">
		...
		<input id="summary" type="textarea" class="form-control" placeholder="summary goes here..." name="summary" value="{{ $page->summary }}">
		@if($errors)      
	...
	<div class="col-md-12 form-group">
		...
		<textarea id="editor" name="description" class="form-control" placeholder="description goes here...">{!! $page->description !!} </textarea>
	...
	<div class="col-md-12 form-group">
		...
		@if($page->image)
		<img src="{{ asset('uploads/pages/'.$page->image)}}" width="100px">
		@else
	...
	<div class="col-md-12 form-group">
		...
		@if($page->attachment)
		<a href ="{{ asset('uploads/pages/'.$page->attachment)}}"> <i class="fa fa-file"> view </i> </a>
		@else
...
<fieldset class="fieldset-border">
	...
	<div class="col-md-6 form-group">
		...
		{!! Form::select('status',$data['publish_options'],$page->status,['class'=>'form-control']) !!}
		@if($errors)      
