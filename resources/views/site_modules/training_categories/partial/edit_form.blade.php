<fieldset class="fieldset-border">
	...
	<div class="col-md-12 form-group">
		...
		<img src="{{ asset('uploads/training_categories/'.$training_category->image)}}" width="100px">
		@else
...
<fieldset class="fieldset-border">
	...
	<div class="row col-md-12">
		<div class="col-md-4 form-group">
			...
			{!! Form::number('order',$training_category->order,['class'=>'form-control']) !!}
			@if($errors)      
	...
	<div class="row col-md-12">
		<div class="col-md-4 form-group">
			...
			{!! Form::select('status',$data['publish_options'],$training_category->status,['class'=>'form-control']) !!}
			@if($errors)      
