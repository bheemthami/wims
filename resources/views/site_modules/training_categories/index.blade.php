        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('training-categories.create') }}"> <i
                            class="fa fa-plus"></i> Add New Training Category
                    </a>
                </div>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                            ...
                            @forelse($training_categories as $training_category)
                                <tr>
                                    ...
                                    <td>
                                        @if ($training_category->image)
                                            <div class="img-wrapper">
                                                <img src="{{ asset('uploads/training_categories/' . $training_category->image) }}"
                                                    alt="No Image">
                                            </div>
                                        @else
                                            -
                                    ...
                                    <td>
                                        <div class="action-button-list">
                                            <a class="btn btn-sm btn-success"
                                                href="{{ route('training-categories.edit', [$training_category->id]) }}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal"
                                                data-id="{{ $training_category->id }}"
                                                data-route="{{ route('training-categories.destroy', $training_category->id) }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            function filterData(filters) {
                ...
                $.ajax({
                    url: "<?php echo url('admin/training-categories'); ?>",
                    data: filters,
