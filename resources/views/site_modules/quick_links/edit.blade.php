...
<section class="content">
	...
	<div class="box">
		...
		<div class="box-body">
			{!! Form::model($quick_link,['route'=>['quick-links.update',$quick_link->id],'method'=>'PATCH','enctype'=>'multipart/form-data']) !!}
			{{ csrf_field() }}
			@include('site_modules.quick_links.partial.edit_form')
