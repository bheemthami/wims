<fieldset class="fieldset-border">
	...
	<div class="col-md-6 form-group">
		...
		{!! Form::select('post_category_id',$data['post_category_options'],$post->post_category_id,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-12 form-group">
		...
		<textarea id="summary" name="summary" class="form-control" rows="2" placeholder="summary goes here...">{!! $post->summary !!}</textarea>
		@if($errors)
	...
	<div class="col-md-12 form-group">
		...
		<textarea id="editor" name="description" class="form-control" placeholder="description goes here...">{!! $post->description !!}</textarea>
		@if($errors)
	...
	<div class="col-md-12 form-group">
		@if($post->image)
		<a class="btn btn-sm btn-success" href="{{ asset('uploads/notices/'.$post->image)}}"> <i class="fa fa-file"> view </i> </a>
		@else
	...
	<div class="col-md-12 form-group">
		...
		@if($post->attachment)
		<a class="btn btn-sm btn-success" href="{{ asset('uploads/posts/'.$post->attachment)}}"> <i class="fa fa-file"> view </i> </a>
		@else
		<span class="text-danger"> No Attachment</span>
		@endif
		<br>
...
<fieldset class="fieldset-border">
	...
	<div class="col-md-4 form-group">
		...
		{!! Form::select('status',$data['publish_options'],$post->status,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-4 form-group">
		...
		{!! Form::select('show_on_modal',[1=>'YES', 0=>'NO'],$post->show_on_modal,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-4 form-group">
		...
		{!! Form::text('date',$post->date,['class'=>'form-control','id'=>'published_date']) !!}
		@if($errors)
