        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('trainings.create') }}"> <i class="fa fa-plus"></i> Add
                        New Training</a>
                </div>
            </div>
            <div class="box-body table-responsive no-padding">
                <div class="filteration">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            {!! Form::select('training_category_id', $trainingCategoryOptions, null, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            {!! Form::select('training_type_id', $trainingTypeOptions, null, [
                                'class' => 'form-control',
                                'id' => 'training_type_id',
                            ]) !!}
                        </div>
                                    ...
                                    <td>
                                        <div class="action-button-list">
                                            <a class="btn btn-sm btn-primary"
                                                href="{{ route('trainings.show', [$training->id]) }}"><i
                                                    class="fa fa-eye"></i></a>
                                            <a class="btn btn-sm btn-success"
                                                href="{{ route('trainings.edit', [$training->id]) }}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal"
                                                data-id="{{ $training->id }}"
                                                data-route="{{ route('trainings.destroy', $training->id) }}"> <i
