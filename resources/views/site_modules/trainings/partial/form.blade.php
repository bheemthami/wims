<fieldset class="fieldset-border">
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('training_category_id',$data['training_category_options'],null,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('training_type_id',$data['training_type_options'],null,['class'=>'form-control']) !!}
		@if($errors)   
