                    ...
                    <div class="filteration">
                        <div class="col-md-8">
                            ...
                            <div class="form-group col-md-8">
                                <input id="symbol_no" name="symbol_no" class="form-control"
                                    placeholder="Enter your symbol no" autofocus="true">
                            </div>
                        </div>
                    </div>
                    <div class="form-inline">
                        <div class="pull pull-right">
                            <div class="form-group">
                                <button id="search-button" class="btn btn-success pull-right" type="button"> <i
                                        class="fa fa-search"></i> Search</button>
                            </div>
                            <div class="form-group">
                                <a class="btn btn-danger pull-right" href="{{ url('admin/dashboard') }}"> <i
                    ...
                    <div class="panel panel-default">
                        <div class="panel panel-heading">
                            <div class="form-inline">
                                ...
                                <div class="pull pull-right">
                                    <label class="label label-warning">Enter '-' for no mark</label> <label
                                        class="label label-lg label-danger">Please verify attendance before mark
                                        entry</label>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <div class="panel panel-body">
                            <form id="mark_entry_form" method="POST" action="{{ route('marks.store') }}"
                                    ...
                                    @foreach ($subjects as $subject)
                                        <div id="{{ $subject->id }}" class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                ...
                                                {!! Form::radio('mark[' . $subject->short_name . '][' . 'attendance]', '1', true, [
                                                    'class' => 'present',
                                                    'id' => 'attendance-' . $subject->id,
                                                ]) !!}
                                                <label>Present</label>
                                                <br>
                                                {!! Form::radio('mark[' . $subject->short_name . '][' . 'attendance]', '0', false, [
                                                    'class' => 'abscent',
                                                    'id' => 'attendance-' . $subject->id,
                                                ]) !!}
                                                <label>Absent</label>
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label for="name">TH Mark
                                                    ({{ $subject->theory_fm }})<span>*</span></label>
                                                {!! Form::text('mark[' . $subject->short_name . '][' . 'obt_th_mark]', null, [
                                                    'id' => 'th-' . $subject->id,
                                                ...
                                                @if ($errors)
                                                    <span
                                                        class="text-danger"><i>{{ $errors->first('mark.' . $subject->short_name . '.obt_th_mark') }}</i></span>
                                                @endif
                                            </div>
                                            @if ($subject->only_theory == 0)
                                                <div class="col-md-2 form-group">
                                                    <label for="name">PR Mark
                                                        ({{ $subject->only_theory == 1 ? '-' : $subject->practical_fm }})<span>*</span></label>
                                                    {!! Form::text('mark[' . $subject->short_name . '][' . 'obt_pr_mark]', null, [
                                                        'id' => 'pr-' . $subject->id,
                                                        'class' => 'form-control marks',
                                                        'data-parsley-required' => 'true',
                                                    ]) !!}
                                            ...
                                            <div class="col-md-2 form-group">
                                                ...
                                                {!! Form::text('mark[' . $subject->short_name . '][' . 'obt_total_mark]', null, [
                                                    'id' => 'total-' . $subject->id,
                                                    'class' => 'form-control',
                                                    'readOnly' => true,
                                                ]) !!}
