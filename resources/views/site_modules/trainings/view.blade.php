        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-success" href="{{ route('trainings.edit', [$training->id]) }}"><i
                ...
                <fieldset class="fieldset-border">
                    ...
                    <div class="col-md-12">
                        ...
                        @if ($training->attachment)
                            <a href ="{{ asset('uploads/trainings/' . $training->attachment) }}" target="_blank"><i
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <p><strong> Display Order: </strong><label
                                    class="label label-success">{{ $training->order }}</label></p>
                        </div>
                        <div class="col-md-6">
