<fieldset class="fieldset-border">
	...
	<div class="col-md-4 form-group">
		...
		{!! Form::select('gender',$data['gender_options'],$official->gender,['class'=>'form-control']) !!}
		@if($errors)
...
<fieldset class="fieldset-border">
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('local_level_type_id',$data['lltype_options'],$official->local_level_type_id,['class'=>'form-control']) !!}
		@if($errors)
...
<fieldset class="fieldset-border">
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('academic_year_id',$data['year_options'],$official->academic_year_id,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('department_id',$data['department_options'],$official->department_id,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('designation_id',$data['designation_options'],$official->designation_id,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('working_status',$data['working_status_options'],$official->working_status,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('is_teaching_official',$data['teaching_status_options'],$official->is_teaching_official,['class'=>'form-control']) !!}
		@if($errors)
...
<fieldset class="fieldset-border">
	...
	<div class="col-md-3 form-group">
		...
		{!! Form::select('status',$data['publish_options'],$official->status,['class'=>'form-control']) !!}
		@if($errors)
	...
	<div class="col-md-3 form-group">
		<label for="name">Publish on front page ? <span>*</span></label>
		{!! Form::select('show_on_front_page',$data['yes_no_options'],$official->show_on_front_page,['class'=>'form-control']) !!}
		@if($errors)
		<span class="text-danger"><i>{{$errors->first('show_on_front_page')}}</i></span>
		@endif
	</div>
</fieldset>