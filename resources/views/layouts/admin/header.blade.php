<header class="main-header">
  ...
  <a href="{{URL::to('admin/dashboard')}}" class="logo">
    ...
    <span class="logo-lg">
      <img style="margin-left: 70px; " class="image img-responsive" src="{{ asset('uploads/setting/'.$settings['setting']->logo) }}" height="50" width="50" alt="LOGO">
    </span>
  </a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="{{asset('uploads/setting/'.$settings['setting']->logo)}}" class="user-image" alt="User Image">

            <span class="hidden-xs"> {{ Sentinel::getUser()->first_name }} {{ Sentinel::getUser()->last_name }} -
