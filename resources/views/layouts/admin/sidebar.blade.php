  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" >
       ...
       <li class="treeview">
        <a href="#">
          <i class="fa fa-file"></i> <span>Publications related</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
     ...
     <li class="treeview">
      <a href="#">
        <i class="fa fa-wrench"></i> <span >Trainings related</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
   ...
   <li class="treeview">
    <a href="#">
      <i class="fa fa-cogs"></i> <span >Others</span>
      <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>
    </a>
    <ul class="treeview-menu">
      ...
      <li><a href="{{ route('pages.index') }}"><i class="fa fa-clock-o"></i> <span>Pages</span></a></li>
      @endif
      ...
      <li><a href="{{ route('embeddings.index') }}"><i class="fa fa-image"></i> <span>Embeddings</span></a></li>
      @endif

      @if(Sentinel::hasAccess('galleries.index'))
      <li><a href="{{ route('galleries.index') }}"><i class="fa fa-image"></i> <span>Galleries</span></a></li>
      @endif
