            ...
            @forelse($facilities as $key =>$facility)
                <div class="row mb-50">
                            ...
                            <div class="custom-thumb mb-25 photo-animate">
                                @if (count($facility->images) > 0)
                                    <img class="img img-responsive"
                                        src="{{ asset('uploads/media/' . $facility->images[0]->image) }}" alt="No Image">
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <div class="custom-wrapper mb-30">
                            <div class="custom-thumb mb-25 photo-animate">
                                @if (isset($facility->images[1]))
                                    <img class="img img-responsive"
                                        src="{{ asset('uploads/media/' . $facility->images[1]->image) }}" alt="No Image">
                                @endif

                                @if (!isset($facility->images[1]) && isset($facility->images[0]))
                                    <img class="img img-responsive"
                                        src="{{ asset('uploads/media/' . $facility->images[0]->image) }}" alt="No Image">
                                @endif
                            </div>
