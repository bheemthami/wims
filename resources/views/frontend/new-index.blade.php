    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-lg-5">
        <div class="about-right-img mb-30">
          <img src="{{ asset('uploads/pages/'.$page['about_us']->image)}}" alt="">
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="section-title mb-50 text-center">
                    <div class="section-title-heading mb-20">
                        <h1 class="primary-color">Our Recents Updates</h1>
                    </div>
                    <div class="section-title-para">
                        <p class="gray-color">We do updates on time</p>
                    </div>
                </div>
            </div>
          </div> -->
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade {{ ($key== 0) ? 'show active':''}}" id="pills-{{$cat['slug']}}" role="tabpanel" aria-labelledby="pills-home-tab">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item"><a href="{{route('post-details',$post->slug)}}"> {{ $post->title }} </a>
                        <br>
                        <span class="float-left published-text"><i class="published-date">Published on: {{ date('M j, Y', strtotime($post->date)) }}</i> </span>
                      </li>
                      @empty
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xl-5 col-lg-5 col-md-6 col-sm-12">
          <div class="about-left-img img img-responsive" style="overflow-x: hidden;">
            <img src="{{ asset('uploads/programs/'.$data['programs'][0]->image)}}" alt="NO IMAGE" width="470">
          </div>
        </div>
        <div class="col-xl-7 col-lg-7 col-md-6 col-sm-12">
          <div class="about-title-section mb-30 mt-30">
            ...
            <a href="{{ route('program-details',$data['programs'][0]->slug)}}" class="theme-btn blue-bg-border mt-20"><span class="btn-text">more...</span></a>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
        <div class="feature-wrapper mb-20 text-center">
          <div class="facility-images photo-animate">
            @if($facility->image)
            <img src="{{ asset('uploads/facilities/'.$facility->image)}}" alt="NO IMAGE" class="img img-responsive">
            @else
      ...
      <div class="col-xl-12">
        <div class="video-wrapper text-center">
          <div class="video-content">
            <a class="popup-video" href="{{ $data['video'] ? $data['video']->link : '#' }}"><img src="frontend/img/video/play_icon.png" alt=""></a>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-3">
                <div class="couter-wrapper mb-30 text-center">
                    <img src="frontend/img/counter/counter_icon1.png" alt="">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3">
                <div class="couter-wrapper mb-30 text-center">
                    <img src="frontend/img/counter/counter_icon2.png" alt="">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3">
                <div class="couter-wrapper mb-30 text-center">
                    <img src="frontend/img/counter/counter_icon3.png" alt="">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3">
                <div class="couter-wrapper mb-30 text-center">
                    <img src="frontend/img/counter/counter_icon4.png" alt="">
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="brand-list">
            <ul>
              <li><img src="{{ asset('uploads/setting/'.$settings->logo)}}" alt="" width="100px"></li>
