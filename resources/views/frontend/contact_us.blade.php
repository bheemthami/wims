                ...
                <div class="contact-info mb-50 wow fadeInRight" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInRight;">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="contact-text">
                                <h5>Location</h5>
                                <span>{{ $settings->office_address }}, {{ $settings->municipality }}, {{ $settings->district_name }} District, {{ $settings->province_name }}, Province, Nepal</span>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <form id="visitor_query_form" method="POST">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <input id="name" class="visitor-query" placeholder="Name :" type="text" name="name">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <input id="email" class="visitor-query" placeholder="Email :" type="text" name="email">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <input id="subject" class="visitor-query" placeholder="Subject :" type="text" name="subject">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <input id="phone" class="visitor-query" placeholder="Phone :" type="text" name="phone">
                            </div>
                            <div class="col-xl-12">
