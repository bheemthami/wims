		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading"> 
					<h3>Given Permissions to <strong>Role - </strong> <span class="badge">{{ $role->name }}</span> <a class="btn btn-sm btn-info" href="{{route('edit.role.permissions',$role->id)}}"><i class="fa fa-pencil"></i> Edit </a>

						<a class="btn btn-sm btn-danger" href="{{route('roles.index')}}"><i class="fa fa-arrow-left"></i> Back </a>
					</h3>
