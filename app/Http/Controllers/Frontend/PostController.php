    ...
    public function index()
    {
        try {
            ...
            if (request()->ajax()) {
               ...
               $posts = $this->postManager->all($params,$setting->academic_year_id,$setting->perp_page);
           ...
           if(Sentinel::hasAccess('posts.index')){
            $params['title'] = null;
            $params['academic_year_id'] = $setting->academic_year_id;
            $params['post_category_id'] = null;
            $posts = $this->postManager->all($params,$setting->perp_page);
