...
class FrontendController extends Controller
{
   ...
   public function __construct(CommonDataManager $commonManager,
...
public function index()
{
    ...
    try {
        ...
        foreach ($post_categories as $key=>$category) {
            ...
            $categories[$key]['posts'] = $this->postManager->topPublishedPosts($settings->academic_year_id,$category->id,8);
        }
