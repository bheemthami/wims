    ...
    public function index()
    {
        try {
            ...
            if (request()->ajax()) {
                ...
                $events = $this->eventManager->all($params,$setting->academic_year_id,$setting->perp_page,null);

                return view('site_modules.events.replace_index',compact('events'));
            }
            ...
            if(Sentinel::hasAccess('events.index')){
                ...
                return view('site_modules.events.index',compact('events'));
            }
